...
public class NProductRegisterView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = NProductRegisterApp.getApplication().getMainFrame();
            aboutBox = new NProductRegisterAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        NProductRegisterApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(nproductregister.NProductRegisterApp.class).getContext().getResourceMap(NProductRegisterView.class);
        fileMenu.setText(resourceMap.getString("fileMenu.text")); // NOI18N
        fileMenu.setName("fileMenu"); // NOI18N

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(nproductregister.NProductRegisterApp.class).getContext().getActionMap(NProductRegisterView.class, this);
