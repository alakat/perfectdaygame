...
create table productos(id int primary key,titulo varchar(255),  hidratos_carbono double,kilocalorias double, proteinas double, grasas double, idCategoria int, idUsuario int);
