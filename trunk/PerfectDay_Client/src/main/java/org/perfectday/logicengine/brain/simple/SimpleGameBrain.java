...
public class SimpleGameBrain extends AbstractGameBrain{
    ...
    public void setBestFunction() {
        if (this.actionBrain.getActionFunction()==null)
            this.actionBrain.setActionFunction(
                    new SimpleActionSelectedFunction());
        if(this.motionBrain.getMovedFunction()==null)
            this.motionBrain.setMovedFunction(new SimpleMovedFunction());        
    }
