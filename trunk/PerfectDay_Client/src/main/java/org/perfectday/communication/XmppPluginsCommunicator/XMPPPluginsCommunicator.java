...
public class XMPPPluginsCommunicator extends PlugCommunication {
    ...
    private static final Logger logger =
            Logger.getLogger(XMPPPluginsCommunicator.class);
    ...
    public void connect(String destiny, String typeDestiny) {
        ...
        try {
            ...
            org.apache.log4j.Logger.getLogger(XMPPPluginsCommunicator.class)
                    .error("XMPP Communication error",ex);
    ...
    public void sendMessage_(Message message) {
        org.jivesoftware.smack.packet.Message mes =
